...
const todosElementos = document.querySelectorAll("body *"); // Seleciona todos que estão dentro do body
console.log(todosElementos);

todosElementos.forEach((elemento) => {
  elemento.addEventListener("click", (e) => {
    console.log(e.currentTarget); // Mostra tudo o que foi clicado, inclusive a section
  });
});
